...
export default function AssistantPanel() {
  return (
    <div className="w-full px-3 sm:px-4 md:px-0">
      ...
      <p className="text-[#a3bfa8] mb-5 sm:mb-6 md:mb-8 text-xs sm:text-sm md:text-base lg:text-lg">
      ...
      <div
        ...
        "
      >
        <div className="flex items-center mb-2 gap-1 sm:gap-2 flex-wrap">
          <Lock
            size={18}
            className="text-[#6fbf73] flex-shrink-0 sm:size-5"
          />
        ...
        <p className="text-[#a3bfa8] mb-4 text-xs sm:text-sm md:text-base">
          Ask questions about your inventory, get insights, and receive
          recommendations
        </p>

        <div className="bg-secondary rounded-lg p-3 sm:p-4 md:p-5 mb-4">
          <p className="text-[#e2f1e4] mb-3 text-xs sm:text-sm md:text-base leading-relaxed">
        ...
        <div className="flex items-center mt-4 sm:mt-5 bg-[#152518] rounded p-2 gap-2">
          <input
            className="
              flex-1
              bg-transparent
